		...
		<view class="login-bg">
			<view class="login-card">
				...
				<view class="login-input login-margin-b">
					<!--设备序列号：<input type="text"  @input="onInput" v-model="dessid" placeholder="扫码识别序列号" />-->
					设备序列号：{{dessid}}
				</view>
...
<script>
	...
	export default {
		...
		methods: {		
			...
			//getSsid: function(event) {  
                //this.dessid = event.target.value  
            //},  
			async repair(){
				var user;
